    ...
    <Box as="section" id="home" sx={styles.section}>
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="An Information Technology Consulting and Software Development Group To Transform Ideas To Software"
            description="Play by the rules, but be ferocious"
          />
